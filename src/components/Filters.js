                        ...
                        <div className="flex flex-col justify-start">
                            <div id="filter-grouping" className={`${folded ? 'hidden' : 'block'} flex w-full flex-row justify-between items-center`}>
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div 
                                        id="drag-container" 
                                        className="w-full flex flex-col items-center justify-center" style={{width: '300px', height: '300px', borderRadius: '5px', backgroundColor: theme.filterDropInInner, border: `6px dashed ${theme.filterDropInOuter}`}}>
